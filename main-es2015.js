...
let DaysDetailsComponent = class DaysDetailsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let FavoritesComponent = class FavoritesComponent {
    constructor(favoritesService, route, router) {
...
let HomeComponent = class HomeComponent {
    constructor(weatherService, route, favoritesService) {
...
let WeatherService = class WeatherService {
    ...
    getFiveDayForecast(key, metric = true) {
...
let TodeyWeatherComponent = class TodeyWeatherComponent {
    constructor() {
...
let WeatherDetailsComponent = class WeatherDetailsComponent {
    constructor(weatherService, favoritesService) {
        this.weatherService = weatherService;
        this.favoritesService = favoritesService;
    }
    ngOnInit() {
